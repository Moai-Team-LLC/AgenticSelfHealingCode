 ...
 *
 * BrokenClass and LoopBDecision are imported from the shared @sho/contracts spine — never re-declared.
 */
 ...
 *  heal candidate. */
export function classify(s: BrokenSignals): LoopBDecision {
...
// Re-export the contract types so downstream Loop B consumers can pull the class taxonomy from here.
export type { BrokenClass, LoopBDecision }
